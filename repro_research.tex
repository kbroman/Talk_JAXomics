...
\\[2pt]
\scriptsize {\lolit Slides:} \href{https://kbroman.org/Talk_JAXomics}{\tt
  \color{foreground} kbroman.org/Talk\_JAXomics}
}
...
\frame{
  ...
  \note{This lecture is based on slides for a talk I've given a whole
    bunch of times. This version is for a short course on multiomics
    analysis, at the Jackson Laboratory.

    Source: {\tt https://github.com/kbroman/Talk\_JAXomics} \\
    These slides, with notes: \\
    \qquad {\tt https://kbroman.org/Talk\_JAXomics/repro\_research\_withnotes.pdf} \\
    Full slides without notes: {\tt https://kbroman.org/Talk\_JAXomics}
...
\note{
  ...
  it's about assembling and organizing the data and code
...
\note{
  You want the names to be easy to handle in software, which
...
\ei
  ...
  \note{
    ...
    document describing the data, I personally would prefer to have
...
\note{I {\nhilit love} R Markdown for making reproducible reports that
  ...
  Python people should look at {\nhilit Jupyter} notebooks. Many R
...
\note{GNU Make is an old (and rather quirky) tool for automating the
  ...
  An alternative is the R package {\nhilit targets}. Python people
  should look at {\nhilit snakemake}.
}
\end{frame}
...
\ei
  ...
  \note{
    ...
    You can make copies of a file with a version number appended to
...
\item Code
  \bi
\item GitHub / BitBucket / Codeberg
...
\item Institutional repository
  ...
  \note{
    ...
    Place code at GitHub (or the similar site, BitBucket, and many
    people have moved to Codeberg as Microsoft has taken over GitHub). The only problem
...
Slides: \href{https://kbroman.org/Talk_JAXomics}{\tt kbroman.org/Talk\_JAXomics} \quad
